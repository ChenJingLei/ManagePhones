...
namespace ManagePhones.DAL
{
	...
	/// 数据访问类:out_warehouse
	/// </summary>
	public partial class OutWarehouseDAL
	{
		public OutWarehouseDAL()
		{}
		#region  BasicMethod
		...
		public bool Exists(long id)
		{
			...
			strSql.Append("select count(1) from out_warehouse");
		...
		public bool Delete(long id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from out_warehouse ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int64)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,gid,imei,outtime ");
			strSql.Append(" FROM out_warehouse ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from out_warehouse T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "out_warehouse";
